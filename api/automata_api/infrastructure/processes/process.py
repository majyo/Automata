...
from automata_api.core.tools.process_scope import (
    _process_scope,
)
from automata_api.infrastructure.processes.windows_job import WindowsJob
...
def get_process_supervisor() -> ProcessSupervisor:
    ...
    return resources[0] if resources is not None else process_supervisor
