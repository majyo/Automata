...
from automata_api.core.agent.skills.model import SkillMetadata
...
def render_available_skills(
    ...
    *,
    ...
    if not skills:
        return "", ()
    full_lines = [
        render_skill_line(skill, include_description=True) for skill in skills
    ]
    ...
    minimum_lines = [
        render_skill_line(skill, include_description=False) for skill in skills
    ]
