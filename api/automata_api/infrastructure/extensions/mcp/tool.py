...
from automata_api.infrastructure.extensions.mcp.schema import McpError, McpToolMetadata
...
class McpAgentTool(AgentTool):
    ...
    async def run_in_mode(self, arguments: dict[str, Any], *, mode: str) -> ToolResult:
        try:
