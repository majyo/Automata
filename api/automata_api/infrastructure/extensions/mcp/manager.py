...
from automata_api.infrastructure.extensions.mcp.client import (
    McpClient,
    McpSdkClientAdapter,
)
from automata_api.infrastructure.extensions.mcp.config import McpServerDefinition
...
class McpConnectionManager:
    ...
    async def _list_all_pages(self, client: McpClient) -> tuple[McpToolInfo, ...]:
