...
from automata_api.infrastructure.observability.redaction import sha256_text
                ...
                async for line in response.aiter_lines():
                    ...
                    emit_profile_event(
                        "llm.sse_chunk",
                        {
                            ...
                            "has_usage": isinstance(delta.get("usage"), dict),
                        },
                    )
                    yield delta
...
async def post_chat_completion(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    async with observe_span(
        ...
        async with httpx.AsyncClient(timeout=timeout) as client:
            ...
            span.set_attributes(usage=usage if isinstance(usage, dict) else None)
