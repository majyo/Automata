...
from automata_api.core.runs.model import ToolExecutionContext
from automata_api.core.telemetry import observe_span
from automata_api.core.tools.args import parse_tool_arguments
from automata_api.core.tools.models import ToolResult
from automata_api.core.tools.output_scope import tool_output_execution_scope
...
from automata_api.core.tools.policy_engine import ToolPolicyEngine
        ...
        *,
        ...
        if parse_error:
            return failed_result(
                tool_name, arguments, "invalid_tool_arguments", parse_error
            )
        ...
        if decision.action == "prompt" and self.permissions.approval_policy == "never":
            decision = replace(
                decision,
                action="allow",
...
def tool_operation_attributes(
    ...
    return {"operation_mode": (mode if mode in {"search", "files"} else "invalid")}
