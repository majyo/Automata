...
from automata_api.core.tools.args import json_response
from automata_api.core.tools.constants import DEFAULT_EXEC_OUTPUT_CHARS, OUTPUT_LIMIT
...
def search_exit_code_is_ok(exit_code: int | None) -> bool:
