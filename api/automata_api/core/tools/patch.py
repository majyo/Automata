...
from automata_api.core.tools.args import bool_argument, json_response
from automata_api.core.tools.base import AgentTool
from automata_api.core.tools.models import ToolResult
from automata_api.core.tools.patch_codex import (
    CodexPatchFile,
...
from automata_api.core.tools.results import patch_error_result
...
class ApplyPatchPreviewTool(AgentTool):
    ...
    async def run(self, arguments: dict[str, Any]) -> ToolResult:
        ...
        return await run_apply_patch(
            preview_arguments, self.backend, tool_name=self.name
        )
