...
from automata_api.core.tools.thread_context import SearchThreadContextTool
from automata_api.core.tools.tool_search import tool_search_text_for_spec
...
class BackendToolProvider:
    def discover(self, context: ToolDiscoveryContext) -> tuple[ToolDescriptor, ...]:
        ...
        return tuple(
            ...
            for tool in default_tools(context.backend)
        )
