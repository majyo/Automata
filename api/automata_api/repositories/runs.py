...
class SqliteRunStore:
    ...
    def begin_plan_execution(self, **kwargs: Any) -> tuple[
...
def get_default_run_store() -> RunStore:
    """The composition-root default store.

    New code receives a store from ``AppContainer``; this accessor exists
    only so module level defaults and legacy call sites keep working during
    the migration.
    """
